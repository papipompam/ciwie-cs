...
export default defineEventHandler(async (_event) => {
  ...
  await prisma.user.upsert({
    ...
    create: {
      id: 'staff-001', username: 'staff001', passwordHash, role: 'STAFF', status: 'ACTIVE',
  ...
  await prisma.user.upsert({
    ...
    create: {
      id: 'lecturer-001', username: 'lecturer001', passwordHash, role: 'LECTURER', status: 'ACTIVE',
  ...
  await prisma.user.upsert({
    ...
    update: { passwordHash, status: 'ACTIVE', recordStatus: 'ACTIVE', passwordChangedAt: new Date() },
    create: {
      id: 'student-001', username: '66123456701', passwordHash, role: 'STUDENT', status: 'ACTIVE',
