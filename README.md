...
เมื่อ seed ฐานข้อมูลด้วย `ALLOW_DEMO_SEED=true pnpm db:seed` จะมีบัญชีทดสอบพร้อมใช้งาน:

คำสั่งนี้จะ seed เฉพาะบัญชีและข้อมูลโครงสร้างที่จำเป็น หากต้องการข้อมูล workflow เดโม เช่น รายการสมัครและคำร้อง ให้เพิ่ม `SEED_DEMO_WORKFLOW=true`

| บทบาท | ชื่อผู้ใช้ | รหัสผ่านเริ่มต้น |
|---|---|---|
| ผู้ดูแลระบบ | `admin001` | `12341234` |
| นักศึกษา | `000000000000` | `Cwie@2569` |
| อาจารย์ | `lecturer001` | `Cwie@2569` |

หากกำหนด `SEED_DEFAULT_PASSWORD` เอง ให้ใช้ค่านั้นแทนรหัสผ่านของนักศึกษาและอาจารย์ บัญชีทั้งหมดเป็นข้อมูลสำหรับสภาพแวดล้อมทดสอบเท่านั้น
