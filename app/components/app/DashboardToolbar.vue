...
const contextLabel = computed(() => {
  ...
  if (route.path.startsWith('/lecturer/applications')) return 'บริบทข้อมูลการสมัครสหกิจ'
  if (route.path.startsWith('/staff/applications')) return 'บริบทข้อมูลการสมัครสหกิจ'
