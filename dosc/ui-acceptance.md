...
| `/staff/requests` | ตรวจคำร้อง แนบหนังสือ และตรวจหนังสือตอบรับ |
...
| ยื่นและติดตามคำร้อง | `/student/placements*` | ไม่อยู่ในสิทธิ์ | `/staff/requests` |
| ตรวจคำร้องและออกหนังสือ | ดูผลใน `/student/placements/:id` | ไม่อยู่ในสิทธิ์ | `/staff/requests` |
...
2. อาจารย์เข้าสู่ระบบ → ดู/เข้าร่วมตารางนิเทศ → บันทึกผล → ทำแบบประเมิน
3. เจ้าหน้าที่เข้าสู่ระบบ → รับแจ้งเตือนเมื่อนักศึกษายืนยัน → ตรวจคำร้องและจัดการเอกสาร
   → จัดการข้อมูลบุคคล/นำเข้า → จัดการสถานประกอบการ → จัดกลุ่มอาจารย์และมอบหมายบริษัท → ดูตารางนิเทศ
